...
#RDEPENDS:${PN} += "libzebra"
#RDEPENDS:${PN}-ripngd += "libzebra"
#RDEPENDS:${PN}-ripd += "libzebra"
#RDEPENDS:${PN}-isisd += "libzebra"
#RDEPENDS:${PN}-ripd += "libzebra"
...
INSANE_SKIP:${PN}-ripngd += "file-rdeps"
INSANE_SKIP:${PN}-ripd += "file-rdeps"
INSANE_SKIP:${PN}-isisd += "file-rdeps"
INSANE_SKIP:libzebra += "file-rdeps"
