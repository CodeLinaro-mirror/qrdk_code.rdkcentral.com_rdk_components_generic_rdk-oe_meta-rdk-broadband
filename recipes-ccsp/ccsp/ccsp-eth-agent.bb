...
CFLAGS:append = " \
    ...
    "
CFLAGS:append  = " ${@bb.utils.contains('DISTRO_FEATURES', 'WanFailOverSupportEnable', ' -I=${includedir}/rbus ', '', d)}"
CFLAGS:append  = " ${@bb.utils.contains('DISTRO_FEATURES', 'RbusBuildFlagEnable', ' -I=${includedir}/rbus ', '', d)}"
...
LDFLAGS:append = " ${@bb.utils.contains('DISTRO_FEATURES', 'RbusBuildFlagEnable', ' -lrbus ', '', d)}"
LDFLAGS:append = " ${@bb.utils.contains('DISTRO_FEATURES', 'WanFailOverSupportEnable', ' -lrbus ', '', d)}"
LDFLAGS:append = " ${@bb.utils.contains('DISTRO_FEATURES', 'WanFailOverSupportEnable', ' -lsysevent ', '', d)}"
