...
SRC_URI = "${CMF_GITHUB_ROOT}/tr069-protocol-agent;protocol=https;${BRANCH_ccsp_tr069_pa}"
...
CFLAGS:append = " -Wall -Werror -Wextra -Wno-ignored-qualifiers "

CFLAGS:append = " -Wno-deprecated-declarations -Wno-array-bounds "
