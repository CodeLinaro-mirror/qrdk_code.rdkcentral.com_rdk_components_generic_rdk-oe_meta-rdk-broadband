...
SRC_URI = "${CMF_GITHUB_ROOT}/common-library;protocol=https;${BRANCH_ccsp_common_library}"
...
FILES_${PN}_append += " ${@bb.utils.contains('DISTRO_FEATURES', 'dhcp_manager', '/usr/ccsp/dhcpmgr/DHCPMgrPSMValueCheck.sh', '', d)}"
