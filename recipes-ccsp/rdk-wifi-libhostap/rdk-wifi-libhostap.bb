...
SRC_URI += " \
	...
	file://${HOSTAPD_PV}/radar_csa_non_dfs_only_2_11_stable2.patch \
        file://${HOSTAPD_PV}/wpa3_pcm_sta_2_11.patch \
        file://${HOSTAPD_PV}/mlo_rx_link_id_fix.patch \
        file://${HOSTAPD_PV}/fix-crash-on-client-connection-attempts-during-mlo-reconf.patch \
    ','', d)} \
"
...
SRC_URI += " ${@bb.utils.contains('DISTRO_FEATURES', 'HOSTAPD_2_10','file://2.10/comcast_changes_merged_to_source_2_10.patch file://2.10/oneWifiLib.patch file://2.10/greylist.patch file://2.10/broadcom.patch file://2.10/one_wifi_radius_greylist.patch file://2.10/RDKB-48455-hostap-2.10-crash.patch file://2.10/owe_radius_auth_vlan_32.patch file://2.10/RDKB_47882_VLAN_2_10.patch file://2.10/onewifi_cac.patch file://2.10/mcs_bit_set.patch file://2.10/wpa_auth_vlogger_crash.patch \
file://2.10/connected_building_avp_2_10.patch file://2.10/enable-wnm-flag-2-10.patch file://2.10/Supported_Rates_Per_Vap_CAC.patch file://2.10/greylist_connectivity_openvap_2.10.patch file://2.10/wps_pin_led.patch file://2.10/wps_indication_deinit.patch file://2.10/RDKB-53254_Telemetry_2.10.patch file://2.10/wps_term_session.patch file://2.10/CMXB7-5998.patch file://2.10/cmxb7_dfs.patch file://2.10/cohosted_bss_param_210.patch file://2.10/ht_rifs_210.patch \
file://2.10/vht_oper_basic_mcs_set_210.patch file://2.10/tx_pwr_envelope_210.patch file://2.10/pwr_constraint_210.patch file://2.10/supported_op_classes_210.patch file://2.10/he_2ghz_40mghz_bw_210.patch file://2.10/rnr_col_210.patch file://2.10/tpc_report_210.patch file://2.10/driver_aid_210.patch file://2.10/radius_failover_2_10.patch file://2.10/mbssid_support.patch file://2.10/increase_eapol_timeout.patch file://2.10/Dynamic_NAS_IP_Update_2_10.patch \
  file://2.10/wpa3_compatibility_hostap_2_10.patch file://2.10/wpa3_compatibility_rsno_m3_removal_hostap_2_10.patch file://2.10/multi_rsn_key_mgmt_2_10.patch file://2.10/open_auth_workaround.patch file://2.10/mdu_radius_psk_auth_2_10.patch file://2.10/UAPSD_fixed_cap_2_10.patch file://2.10/ap_channel_tag_2_10.patch file://2.10/chan_to_freq_us_2_10.patch file://2.10/xfi-tel-complete_2_10.patch file://2.10/ignite_sta_creds_for_comcast_only_2_10.patch file://2.10/radar_csa_non_dfs_only_2_10_stable2.patch ',\
