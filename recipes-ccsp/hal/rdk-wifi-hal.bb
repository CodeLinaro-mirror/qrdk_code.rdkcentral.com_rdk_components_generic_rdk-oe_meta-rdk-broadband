...
SRCREV = "77e1497180b38d204937465d97a2b78d5705fc2b"
...
ONEWIFI_CONFIG_FLAGS_append_xb10 = " ${@bb.utils.contains('DISTRO_FEATURES', 'CONFIG_IEEE80211BE', ' -DCONFIG_MLO', '', d)}"
ONEWIFI_CONFIG_FLAGS_append_vbvxb9 = " ${@bb.utils.contains('DISTRO_FEATURES', 'CONFIG_IEEE80211BE', ' -DCONFIG_MLO', '', d)}"
ONEWIFI_CONFIG_FLAGS_append_xer10 = " ${@bb.utils.contains('DISTRO_FEATURES', 'CONFIG_IEEE80211BE', ' -DCONFIG_MLO', '', d)}"
