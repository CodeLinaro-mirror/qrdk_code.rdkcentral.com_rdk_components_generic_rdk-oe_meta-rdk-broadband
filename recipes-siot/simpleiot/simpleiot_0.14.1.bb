...
DEPENDS += "go-native elm-binary nodejs-native nodejs-oe-cache-native gyp-native python3-packaging-native curl-native ca-certificates-native"
...
FILES_${PN} += "${exec_prefix}/ccsp/simpleiot" 
FILES_${PN} += "${bindir}/*"
FILES_${PN} += "${libdir}/*"
